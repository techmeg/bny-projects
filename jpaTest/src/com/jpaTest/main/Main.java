...
import com.jpaTest.services.EmployeeDAO;
import com.jpaTest.services.EmployeeServices;
...
public class Main {
	...
	public static void main(String[] args) {
		// instantiating test ID, and two classes
		  ...
		  //create new employee 
		  emp.settel("212-496-7921"); emp.setfName("Max");
